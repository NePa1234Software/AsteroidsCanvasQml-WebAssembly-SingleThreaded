...
var wasmBinaryFile;
  wasmBinaryFile = 'appAsteroidsQml.wasm';
...
function qt_asyncify_resume_js() { let wakeUp = Module.qtAsyncifyWakeUp; if (wakeUp == undefined) return; Module.qtAsyncifyWakeUp = undefined; const suspendId = Module.qtSuspendId; setTimeout(() => { if (Module.qtSuspendId !== suspendId) return; wakeUp(); }); }
  ...
  function _emscripten_set_timeout(cb, msecs, userData) {
      return safeSetTimeout(() => (function(a1) {  dynCall_vi.apply(null, [cb, a1]); })(userData), msecs);
    }
...
var ___start_em_js = Module['___start_em_js'] = 9124188;
var ___stop_em_js = Module['___stop_em_js'] = 9124670;
